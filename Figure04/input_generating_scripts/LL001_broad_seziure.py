...
for i in range(len(iterations)):
    ...
    savepath = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure04\input\broad_sz'
...
np.save(r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure04\input\broad_sz\LL001_ranked.npy', data_LL001)