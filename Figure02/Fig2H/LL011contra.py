...
eventfile = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\input\pinch_events\LL011contra.events'
path_phy_data = r'E:\Manuscript_analysis_files\data\phy_data\LL011_contra-final.GUI'
lightfile = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\Fig2H\input\light011contra.npy'
savedir = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\Fig2H\output_data\LL011contra.npy'
...
times = data.times
good_clusters = [3, 7, 13, 15, 18, 31, 33, 34, 39, 40, 49, 50, 77, 83, 91, 95, 98, 101, 104, 107, 129, 138, 140, 144, 150, 157, 173, 178, 179]
...
events=events[1:11]
events = [(int(x) - 14310144) for x in events]
events = np.array(events)/srate
adjustments = np.array([+0.15, -0.1, -0.1, -0.2, +0.05, -0.1, -0.1, -0.2, -0.35, -0.4])
