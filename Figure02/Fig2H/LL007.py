...
eventfile = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\input\pinch_events\LL007.events'
path_phy_data = r'E:\Manuscript_analysis_files\data\phy_data\LL007-final.GUI'
lightfile = 'NONE'
savedir = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\Fig2H\output_data\LL007.npy'
...
times = data.times
good_clusters = [13,15,22,23,31,34,39,55,68,72,81,84,98,100,107,112,119,123,125,130,133,135,137,141,143,147,155,157,159,171,175,181]
...
events=events[1:11]
events = [(int(x) - 32389376) for x in events]
events = np.array(events)/srate
adjustments = np.array([-0.4, -0.45, -0.35, -0.4, -0.35, -0.6, -0.45, -0.6, -0.3, -0.4])
