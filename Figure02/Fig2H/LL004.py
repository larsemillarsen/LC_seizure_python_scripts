...
eventfile = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\input\pinch_events\LL004.events'
path_phy_data = r'E:\Manuscript_analysis_files\data\phy_data\LL004-final.GUI'
lightfile = 'NONE'
savedir = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\Fig2H\output_data\LL004.npy'
...
times = data.times
good_clusters = [8, 9, 18, 19, 25, 27, 30, 40, 48, 51, 52, 58, 60, 62]
...
adjustments = np.array([-0.35, -0.25, -0.15, -0.45, -0.45, -0.6, -0.2, -0.35, -0.3, -0.5])
