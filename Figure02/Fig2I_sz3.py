...
savepath = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\output\fig2I_sz3.png'
...
ax.set_title('Seizure 3', fontsize=17, fontweight='bold')
