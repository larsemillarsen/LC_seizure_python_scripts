...
savepath = r'E:\Manuscript_analysis_files\LC_seizure_python_scripts\Figure02\output\fig2I_sz2.png'
...
effect = np.array(df2['effect_sz1'].iloc[:97]) # order to seizure 1
effect_label = effect_2
...
ax.set_title('Seizure 2', fontsize=17, fontweight='bold')
